...
public class DbHelper5 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Proximity";    // Database Name

    private static final String TABLE_NAME = "Proximity_Table";
    private static final String COL1 = "ID";
    private static final String COL2 = "Timestamp";
    private static final String COL3 = "ProximityVal";
