...
public class DbHelper3 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Orientation";    // Database Name

    private static final String TABLE_NAME = "Orientation_Table";
    private static final String COL1 = "ID";
    private static final String COL2 = "Timestamp";
    private static final String COL3 = "OX";
    private static final String COL4 = "OY";
    private static final String COL5 = "OZ";
