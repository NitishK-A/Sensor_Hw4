...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String COL2 = "Accelerometer";
    private static final String COL3 = "Gyroscope";
    private static final String COL4 = "Orientation";
    private static final String COL5 = "Proximity";
    private static final String COL6 = "GPS";

    private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
            " (" + COL1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL2 + " VARCHAR(255) ,"+ COL3 + " VARCHAR(255) ,"+ COL4 + " VARCHAR(255) ," + COL5 + " VARCHAR(255) ,"+ COL6 + " VARCHAR(225));";
    ...
    public long addSensorA(String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL2, item1);
    ...
    public long addSensorG(String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL3, item1);
    ...
    public long addSensorO(String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL4, item1);
    ...
    public long addSensorP(String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL5, item1);
    ...
    public long addSensorGPS(String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL6, item1);
