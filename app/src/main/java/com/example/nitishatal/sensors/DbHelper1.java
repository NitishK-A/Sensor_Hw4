...
public class DbHelper1 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Accelerometer";    // Database Name

    private static final String TABLE_NAME = "Accelerometer_Table";
    private static final String COL1 = "ID";
    private static final String COL2 = "Timestamp";
    private static final String COL3 = "AX";
    private static final String COL4 = "AY";
    private static final String COL5 = "AZ";
